...
public class NoticeDAO {
	...
	public String getNoiceList(NoticeDTO dto) {
		...
		try {
			sql = "select notice_no, notice_cont, created_date from notice n join reservation r on n.pmember_code = r.pmember_code where n.pmember_code = ? ORDER BY notice_no";
