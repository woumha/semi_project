...
public class LoginDTO {
	...
	public void setPmember_email(String pmember_email) {
		this.pmember_email = pmember_email;
	}
	public String getPmember_domain() {
		return pmember_domain;
	}
	...
	public int getPmember_phone() {
		return pmember_phone;
	}
	public void setPmember_phone(int pmember_phone) {
	...
	public int getPmember_userlevel() {
		return pmember_userlevel;
	}
	public void setPmember_userlevel(int pmember_userlevel) {
		this.pmember_userlevel = pmember_userlevel;
	}
